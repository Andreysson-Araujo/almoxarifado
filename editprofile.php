            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nickname" name="nickname" placeholder="Digite o seu usuario" value="<?= $userData->nickname ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md ">
                        ...
                        <form action="<?= $BASE_URL ?>user_process.php" method="POST">
                            <input type="hidden" name="password_type" value="changepassword">
                            <div class="form-group">
